...
def verify_prepared(text):
    required = [
        ...
        'db.delete("recurring_pending"', 'db.delete("recurring_rules"',
        'db.delete("subscriptions"', 'db.delete("transaction_templates"',
        'db.delete("budgets"'
    ]
    missing = [value for value in required if value not in text]
    if missing: raise SystemExit("partially prepared LedgerDb.java: " + ", ".join(missing))
...
def main():
    ...
    text = replace_once(text,
        ...
        "    private static final int DB_VERSION = LedgerV2Migration.VERSION;", "database version")
    text = replace_once(text,
